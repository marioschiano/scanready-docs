...
<p align="center">
  <img src="../../img/placeholder-image.svg" alt="Placeholder pannello impostazioni UV di ScanReady" style="max-width:760px;width:100%;">
</p>
...
Se sei nello Step 2 e decidi che la mesh ottimizzata è ancora troppo pesante, torna a **Step 1 - Preview / Reduce**. Abbassa **Final Faces** o **Optimize / Reduce**, clicca di nuovo **Create Low-poly Preview**, poi torna allo Step 2 e clicca di nuovo **Generate UVs** in modo che la mesh UV corrisponda alla nuova ottimizzazione.
