...
- aiutando a mantenere l'asset piu facile da renderizzare;
- rendendo il modello piu pratico per scene interattive.

Questo e utile per musei virtuali, simulazioni training, esperienze di patrimonio culturale, visualizzazione prodotto e ambienti immersivi.

---

## Videogame

I game engine richiedono asset che bilanciano qualita visiva e performance.
...
Questo rende props scansionati, elementi ambiente e oggetti reali piu facili da portare in una pipeline game.
...
L'obiettivo non e sostituire l'archivio della scansione originale.

L'obiettivo e creare una versione pratica che possa essere usata per presentazione, interazione ed esplorazione realtime.
...
Questo puo essere utile per rocce, statue, props, porzioni di terreno, oggetti, rovine, reperti e superfici reali catturate.
...
Il risultato ottimizzato puo essere usato come asset di produzione piu leggero, mantenendo la scansione high-poly originale come sorgente.
...
5. Usa gli step manuali se l'asset richiede piu controllo.
...
Il risultato e un asset piu leggero che mantiene l'aspetto della scansione senza portarsi dietro tutto il peso della geometria originale.
