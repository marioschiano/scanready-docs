...
<div style="flex:0 0 320px; text-align:center;">
  <img src="../../img/step1-preview-view options.jpg" alt="Pannello Step 1 Preview Reduce di ScanReady con pulsante Create Low-poly Preview" style="width:320px; max-width:100%;">
  </div>
