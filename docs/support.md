...
- GPU / CPU information if the issue is performance-related

This helps identify problems more quickly.
...
Designed to simplify photogrammetry optimization workflows directly inside Blender.
